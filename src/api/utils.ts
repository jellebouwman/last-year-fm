...
export const lastFmEntityIdentifierSchema = z.object({
  mbid: z.string(),
  '#text': z.string(),
}).transform((data) => {
...
export type LastFmEntityIdentifier = z.infer<typeof lastFmEntityIdentifierSchema>

export const outdatedBooleanStructure = z.union([z.literal('0'), z.literal('1')])
